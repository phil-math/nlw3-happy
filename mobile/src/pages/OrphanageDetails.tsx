...
export default function OrphanageDetails() {
    ...
    const params = routes.params as OphanageRouteParams
  ...
  if(!orphanage){
    return (
      <View style={styles.container}>
        <Text style={styles.description}> Carrwgando ...</Text>
      </View>
    )
  }


  function handleDeepLinkingGoogleMapRoutes(){
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity style={styles.routesContainer} onPress={handleDeepLinkingGoogleMapRoutes}>
